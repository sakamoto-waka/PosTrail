...
users = User.create!(
  [
    ...
    {email: 'girth@test.com', name: 'ガース', password: 'password', encrypted_password: 'password', introduction: "うまだいすき", profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-user6.jpg"), filename:"sample-user6.jpg")},
    {email: 'sttirup@test.com', name: "寿天楽布", password: 'password', encrypted_password: 'password', introduction: "外乗最高", profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-user7.jpg"), filename:"sample-user7.jpg")},
    {email: 'bit@test.com', name: 'モーイ', password: 'password', encrypted_password: 'password', profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-user8.jpg"), filename:"sample-user8.jpg")}
  ]
)
