...
#### 🌿大変だった点
- 設計書作成：　以前はあまり考えずに実装し、うまくいかなければやり直しというスタイルで学習を行えていたが、PF制作では初期段階でもやり直しは絶対にしないという気持ちで望んだため時間がかかった<br>
...
- DM機能の通知設定:　あまり記事が多くなく、その記事通り実装してもうまく動作しなかったため解決に時間がかかった。<br>しかしデバッグして解決、を自力で行えたためとても勉強になった
